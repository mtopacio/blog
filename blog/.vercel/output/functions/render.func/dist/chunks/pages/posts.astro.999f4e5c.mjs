...
const $$Posts = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Posts;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./posts/2023-07-04-project-announcement.md": () => import('./2023-07-04-project-announcement.md.6d34f753.mjs').then(n => n._)}), () => "../pages/posts/*.md");
